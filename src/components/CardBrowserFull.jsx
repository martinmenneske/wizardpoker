...
export default class CardBrowserFull extends React.Component {
    ...
    render () {
        return (
            ...
            <div className="full-size-disclaimer">
                A thousand apologies, but this site is not ready for actual computers yet, 
                so you are being served the tablet-optimized version instead.   
            </div>
