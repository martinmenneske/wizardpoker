...
const API_CREDS = {
    "X-Mashape-Key": "oWBWUrFHJJmshIc9h9k1c034BThep1uCZTFjsnNat8Vi3QzlSY"
};
...
export default class App extends React.Component {
    constructor(props) {
        ...
        */
        ...
        localGoldenValue == "showbling"
            ? (goldenCardsYesno = true)
            : (goldenCardsYesno = false);
    ...
    setInitialState() {
        ...
        if (this.state.saveStateLocal) {
            ...
            let savedHistory = JSON.parse(
                localStorage.getItem("lastHistoryState")
            );
            ...
            <div id="top-wrap" className="">
                {this.state.currentCard ? (
                    <div className="app-outer-wrapper">
                        <MediaQuery minDeviceWidth={320} maxDeviceWidth={766}>
                            <CardBrowserMobile
                        ...
                        <MediaQuery minDeviceWidth={767} maxWidth={1223}>
                            <CardBrowserTablet
                                cardData={this.state.currentCard}
                                allCardsData={this.state.allCards}
                                cardHistory={this.state.cardHistory}
